...
export default function DiscourseKingdomForeverBlack() {
        ...
        <div className="lesson-card">
          ...
          <div className="reflection-section">
            ...
            <div className="main-question reflection-q">
              ...
              <p>Que nos enseña este relato sobre Jehova?</p>
            </div>
            <div className="main-question reflection-q">
        ...
        <div className="lesson-card">
          <div className="lesson-header">
            ...
            <h1 className="lesson-title">No se inclinan delante de la estatua</h1>
                    ...
                    <div className="lesson-image-section">
                        <img src={Imagen2} alt="Imagen leccion 60 - El Reino que durara para siempre" className="lesson-image" />
                    </div>
          ...
          <div className="reflection-section">
            ...
            <div className="main-question reflection-q">
              ...
              <p>Que nos enseña este relato sobre Jehova?</p>
                                ...
                                <div className="lesson-image-section">
                        <img src={Imagen3} alt="Imagen leccion 60 - El Reino que durara para siempre" className="lesson-image" />
                    </div>
